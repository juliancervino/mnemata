...
void main() {
  group('BackupSchedulerService', () {
    ...
    test('runIfDue executes daily backup when policy constraints are met', () async {
      final provider = _RecordingCloudBackupProvider();
      final tempDir = await Directory.systemTemp.createTemp('scheduler_due_test_');
    ...
    test('runIfDue skips and records reason when wifi or charging is unmet', () async {
      final provider = _RecordingCloudBackupProvider();
